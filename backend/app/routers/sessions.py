...
TOPIC_POOL: dict[str, list[str]] = {
    "General": [
        ...
        "Is startup culture overrated?",
        "Cricket vs other sports — does India invest fairly?",
        "Electric vehicles: are we ready for the switch?",
        "Brain drain: should IIT graduates stay in India?",
        "Is English dominance harming regional languages?",
        "Should voting be made mandatory in India?",
        "Gig economy: freedom or exploitation?",
        "Is nuclear energy the answer to India's power crisis?",
        "Online education vs traditional classroom learning",
        "Should junk food be taxed heavily?",
        "Is India ready for a cashless economy?",
        "Privacy vs national security: where to draw the line?",
        "Should reservations be based on income not caste?",
        "Climate change: individual or corporate responsibility?",
        "Are internships exploiting students?",
        "Should the retirement age be increased to 70?",
    ],
    "TCS": [
        "Digital transformation in Indian SMEs",
        "Cloud adoption challenges for enterprise",
        "Cybersecurity in the age of remote work",
        "Is low-code/no-code replacing developers?",
        "Data privacy laws: compliance vs innovation",
        "Agile vs waterfall for large IT projects",
        "Should IT companies invest more in Tier-2 city hiring?",
        "Open source software: threat or opportunity for IT firms?",
    ],
    "Infosys": [
        "Ethics in AI development",
        "Upskilling the Indian workforce for Industry 4.0",
        "Is outsourcing still relevant in 2025?",
        "Women in tech: progress or still a long way to go?",
        "Should IT firms mandate return to office?",
        "Moonlighting in tech: ethical or not?",
        "Green IT: can tech companies go carbon neutral?",
        "Is India becoming a product nation or still services?",
    ],
    "Deloitte": [
        "Sustainability as a business strategy",
        "ESG reporting: necessity or burden?",
        "Should consulting firms be liable for client failures?",
        "Four-day work week: productivity myth or reality?",
        "Diversity quotas in leadership: effective or tokenism?",
        "Is the Big 4 model outdated for modern consulting?",
        "Automation in auditing: threat to accountants?",
        "Should companies disclose CEO-to-worker pay ratio?",
    ],
    "Accenture": [
        "Generative AI in enterprise consulting",
        "Future of work post-pandemic",
        "Is digital transformation just an expensive buzzword?",
        "Should companies own their AI models or use third-party?",
        "Metaverse in business: hype or next frontier?",
        "Is India's IT sector too dependent on the US market?",
        "Responsible AI: who should regulate it?",
        "Hybrid work: best of both worlds or worst of both?",
    ],
}
